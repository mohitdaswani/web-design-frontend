      ...
      <div className="pageLayout">
        ...
        <div className="boxstyle">
            ...
            {({ errors, touched }) => (
              ...
              >
                <Field
                  ...
                  placeholder="Email"
                />
                {errors.email && touched.email ? <p style={{ textAlign: "center", marginLeft: "8px" }}>{errors.email}</p> : <br />}
            ...
            render={renderProps => (
              ...
              >
                {/* <img
                  ...
                  height="25px"
                /> */}
                {/* <SocialIcon url="https://facebook.com/" style={{width: "20px"}}/> */}
                <BsFacebook style={{color: "#4267B2"}}/>
                &nbsp;Login with Facebook
              </button>
            )}
          />
          ...
          {this.state.thirdpartyError ? (
            <p style={{ color: "#4267B2" }}>{this.state.thirdpartyError}</p>
          ) : null}

          <br />
          <p style={{ color: "#F8F8FF", marginLeft: "8px" }}>
            New here?{" "}
            <Link
              to="/user/register"
